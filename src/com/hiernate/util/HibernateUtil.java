...
//	查找公告的总记录数
	public static int findPlacardCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Placard").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找上外出登记的总记录数
	public static int findWaichuCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Waichu").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找请假的总记录数
	public static int findQingjiaCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Qingjia").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找出差信息的总记录数
	public static int findChuchaiCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Chuchai").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找上下班登记信息的总记录数
	public static int findOndutyCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Onduty").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找上下班登记信息的总记录数
	public static int findQiyeCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Qiye").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找部门计划的总记录数
	public static int findBmCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Bm").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找个人计划的总记录数
	public static int findPersonCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Person").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找审查表的总记录数
	public static int findShenheCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Shenhe").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找通讯信息组内总记录数
	public static int findTongXunCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from TongXunAdd").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
...
//	查找通讯组内总记录数
	public static int findTCount() {
		...
		try {
			session = hib.openSession();
			tx = (Transaction) session.beginTransaction();
			intCount = ((Integer) session.createQuery("select count(*)from Tongxun").uniqueResult()).intValue();
			tx.commit();
			hib.closeSession(session);
		} catch (Exception e) {
			e.printStackTrace();
